...
<html>
	...
	<body>
		...
		<form method="POST" name="hire" onsubmit="return validateHire()">
			<center>
					...
					<table align="center" width="80%" >
						...
						<tr>
							<td colspan="2" align="center" >
								<input type="submit" name="request" value="Request" onclick="Process()" style="background-color: mediumseagreen; color: white; font-size:30; font-family:Times New Roman;width:80%;">
							</td>
						</tr>
					</table>
				</fieldset>
