<html>
	...
	<body>
		...
		<form method="POST" action="../controller/loginCheck.php" name="login" onsubmit="return validateLogin()">
			<center>
				...
				<h1 style="color:mediumseagreen; font-family:Lucida Handwriting;">Welcome to the Marketplace</h1>
					<table align="center" width="80%" >
						<tr>
							...
							<td width="50%"><input type="email" name="email"  value=" " placeholder="Enter the Email"></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input type="password" name="pass"  value="" placeholder="Enter the Password"></td>
						</tr>
						<tr>
