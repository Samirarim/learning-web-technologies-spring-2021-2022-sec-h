...
<html>
	...
	<body>
		...
		<form method="POST" action="../controller/SignupCheck.php" name='reg' onsubmit="return validateSignUp()">
			<center>
				<fieldset style="height:100%;width:50%;border-width:10px;border-color:mediumseagreen;">
				...
				<h1 style="color:mediumseagreen; font-family:Lucida Handwriting;">Welcome to the Marketplace</h1>
					<table align="center" width="80%" >
						<tr>
							...
							<td width="50%"><input type="text" name="username" rquired value=" "></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td width="50%"><input type="date"  id = "dob" name="dob" value=""></td>
						</tr>
						<tr>
							<td colspan="2"><hr style="height:5px;background-color:mediumseagreen;"></td>
						</tr>
						<tr>
							...
							<td width="50%"><input type="email" name="email" id = "email" value=" " placeholder="Enter the Email"></td>
						</tr>
						<br><?=$error?>
						<tr>
							<td colspan="2"><hr style="height:5px;background-color:mediumseagreen;"></td>
						...
						<tr>
							...
							<td><input type="password" name="pass" id = "pass" value="" placeholder="Enter the Password"></td>
						</tr>
						<tr>
							<td colspan="2"><hr style="height:5px;background-color:mediumseagreen;"></td>
						</tr>
						<tr>
							...
							<td> <input type="password" name="Cpass" id = "Cpass" value="" placeholder="Confirm the Password"></td>
						</tr>
						<tr>
