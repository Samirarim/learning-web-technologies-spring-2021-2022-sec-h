				...
				<legend style="color:green; font-size:50;margin: 6%; text-align:left; " ><b>Profile</b></legend>
					<table align="center" width="80%">
						...
						<tr>
							...
							<td width="50%"><input type="text" name="username" value="<?=$userArray[1]?>"></td>
										<?php
												}
											?>
						</tr>
							...
							<td style="color:green;font-size:20;"><b>Date of Birth</b></td>
											<?php 
												...
												while (!feof($file)) {
													...
													$userArray = explode("|", $user);
											?>
							<td width="50%"><input type="date" name="dob" value="<?=$userArray[3]?>"></td>
											<?php
												}
											?>
						</tr>
							...
							<td style="color:green;font-size:20;"><b>Email</b></td>
											<?php 
												...
												while (!feof($file)) {
													...
													$userArray = explode("|", $user);
											?>
							<td width="50%"><input type="email" name="email" value="<?=$userArray[4]?>"></td>
											<?php
												}
											?>
						</tr>
							...
							<td style="color:green;font-size:20;"><b>Password</b></td>
											<?php 
												...
												while (!feof($file)) {
													...
													$userArray = explode("|", $user);
											?>
							<td><input type="password" name="pass" value="<?=$userArray[5]?>"></td>
											<?php
												}
											?>
						</tr>
